...
// $ gcc pkcs1-v1_5_test.c pkcs1-v1_5.c -o pkcs-v1_5-test -I../out/gmp/include -L../out/gmp/lib -lgmp -I../out/include -L../out/lib -lutils -lhash -lrand
int main(int argc, char *argv[])
{
    ...
    EMSA_PKCS1_v1_5_Encode(HASH_ALG_SHA1, message1, sizeof(message1), 128, buf);

    dump("  origin m1:", message1, sizeof(message1));
    dump("encoding m1:", buf, 128);
