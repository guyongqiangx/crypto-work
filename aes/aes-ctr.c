...
/*
 * @        file: aes-ctr.c
 * @ description: implementation for the AES Counter (CTR) Mode
 * @      author: Gu Yongqiang
 * @        blog: https://blog.csdn.net/guyongqiangx
 */
#include <stdio.h>
...
int AES_CTR_Encrypt(AES_ALG alg, const unsigned char *in, unsigned int size, const unsigned char *key, const unsigned char *nonce, unsigned char *out)
{
...
int AES_CTR_Decrypt(AES_ALG alg, const unsigned char *in, unsigned int size, const unsigned char *key, const unsigned char *nonce, unsigned char *out)
{
//    unsigned char vector[AES_BLOCK_SIZE], temp[AES_BLOCK_SIZE];
//    int i;
//
