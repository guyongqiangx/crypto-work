static int test_AES128_ECB(void)
{
    ...
    AES_ECB_Encrypt(AES128, data, DATA_SIZE, key, enc);
    printf("encryption: \n");
    print_buffer(enc, DATA_SIZE, "      ");

    memset(dec, 0, DATA_SIZE);
    AES_ECB_Decrypt(AES128, enc, DATA_SIZE, key, dec);
    printf("decryption: \n");
...
static int test_AES192_ECB(void)
{
    uint8_t data[DATA_SIZE] =
    {
        0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a,
    ...
    memset(enc, 0, DATA_SIZE);
    AES_ECB_Encrypt(AES192, data, DATA_SIZE, key, enc);
    printf("encryption: \n");
    print_buffer(enc, DATA_SIZE, "      ");

    memset(dec, 0, DATA_SIZE);
    AES_ECB_Decrypt(AES192, enc, DATA_SIZE, key, dec);
    printf("decryption: \n");
    print_buffer(dec, DATA_SIZE, "      ");
...
static int test_AES256_ECB(void)
{
    ...
    /*
     * SP 800-38A: F.1.5 ECB-AES256.Encrypt
    ...
    memset(enc, 0, DATA_SIZE);
    AES_ECB_Encrypt(AES256, data, DATA_SIZE, key, enc);
    printf("encryption: \n");
    print_buffer(enc, DATA_SIZE, "      ");

    memset(dec, 0, DATA_SIZE);
    AES_ECB_Decrypt(AES256, enc, DATA_SIZE, key, dec);
    printf("decryption: \n");
    print_buffer(dec, DATA_SIZE, "      ");
...
{
    printf("AES-128 ECB Encryption/Decryption Test:\n");
    test_AES128_ECB();
    printf("\n");

    printf("AES-192 ECB Encryption/Decryption Test:\n");
    test_AES192_ECB();
    printf("\n");

    printf("AES-256 ECB Encryption/Decryption Test:\n");
    test_AES256_ECB();
    printf("\n");
}