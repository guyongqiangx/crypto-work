...
TEST(MGF, MGFMetaTest)
{
     ...
     * Test 1
     */
    const unsigned char str1[] = {0x66, 0x6f, 0x6f}; // "foo";
    const unsigned char res1[3] = {0x1a, 0xc9, 0x07};
    MGF1(str1, sizeof(str1), HASH_ALG_SHA1, 3, buf);
    EXPECT_EQ(0, memcmp(buf, res1, 3));

    /*
     * Test 2
     */
    const unsigned char str2[] = {0x66, 0x6f, 0x6f}; // "foo";
    const unsigned char res2[5] = {0x1a, 0xc9, 0x07, 0x5c, 0xd4};
    MGF1(str2, sizeof(str2), HASH_ALG_SHA1, 5, buf);
    EXPECT_EQ(0, memcmp(buf, res2, 5));

    /*
     * Test 3
     */
    const unsigned char str3[] = {0x62, 0x61, 0x72}; // "bar";
    const unsigned char res3[5] = {0xbc, 0x0c, 0x65, 0x5e, 0x01};
    MGF1(str3, sizeof(str3), HASH_ALG_SHA1, 5, buf);
    EXPECT_EQ(0, memcmp(buf, res3, 5));

    /*
     * Test 4
     */
    const unsigned char str4[] = {0x62, 0x61, 0x72}; // "bar";
    ...
    const unsigned char res4[50] = {
        ...
        0x48, 0x76};
    MGF1(str4, sizeof(str4), HASH_ALG_SHA1, 50, buf);
     ...
     * Test 5
     */
    const unsigned char str5[] = {0x62, 0x61, 0x72}; // "bar";
    ...
    const unsigned char res5[50] = {
        ...
        0xea, 0xe1};
    MGF1(str5, sizeof(str5), HASH_ALG_SHA256, 50, buf);
