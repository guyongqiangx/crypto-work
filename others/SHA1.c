...
void SHA1ProcessMessageBlock(SHA1Context *context)
{
	...
	printf("block:\n");
	print_buffer(context->Message_Block, 64);
	/*
	...
	*/
	...
	for(t = 0; t < 20; t++)
	{
		...
		printf("%02d:\n", t);
		printf("T=0x%08x, W=0x%08x\n", temp, W[t]);
		printf("e=0x%08x, d=0x%08x, c=0x%08x, b=0x%02x, a=0x%08x\n", E, D, C, B, A);
	...
	printf("hash:\n");
	print_buffer(context->Intermediate_Hash, sizeof(context->Intermediate_Hash));
}
